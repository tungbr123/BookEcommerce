        ...
        <div class="col-md-5 col-lg-4 order-md-last">
            ...
            <c:forEach items="${sessionScope.ListCartItem }" var= "p">
                <li class="list-group-item d-flex justify-content-between lh-sm">
                    <div>
                        <h6 class="my-0">${p._productId._name  }</h6>                    </div>
                    <span class="text-muted">₹${p._productId._promotionalPrice * p._count}</span>
                </li>
            </c:forEach>
            ...
            <form class="needs-validation" action="checkout" method="post" novalidate>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="address" class="form-control" id="address" placeholder="Apartment or suite">
                    </div>
